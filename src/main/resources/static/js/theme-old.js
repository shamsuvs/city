  ...
  var inputFormatter = function () {
    ...
    for (var i = 0; i < input.length; i++) {
      ...
      switch (inputFormat) {
        ...
        default:
          console.error('Sorry, your format ' + inputFormat + ' is not available. You can add it to the theme object method - inputFormatter in src/js/theme-old.js or choose one from the list of available formats: card, cvc, date, date-long, time or custom.');
      }
    }
  }();
  /**
