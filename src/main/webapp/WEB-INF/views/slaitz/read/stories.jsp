                ...
                <div class="col-lg-9 content py-4 mb-2 mb-sm-0 pb-sm-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="py-1 my-2 breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Slaitz Stories
                            </li>
                        </ol>
                    </nav>
                    <!-- Blog grid-->
                    <div class="masonry-grid overflow-hidden" data-columns="3">
                        ...
                        <div class="masonry-grid-item">
                            <c:set var="snipUrl" value="/slaitz/story/${story.id}"></c:set>

                            <article class="card card-hover"><a class="card-img-top" href="${snipUrl}/">
                                <img src="${story.image}" alt="Dubai Driving Theory Tests" title="Dubai Driving Theory Tests"></a>
                                <div class="card-body"><a class="meta-link fs-sm mb-2" href="${snipUrl}">${story.author}</a>
                                    <h2 class="h5 nav-heading mb-4"><a href="${snipUrl}">${story.title}</a></h2>
                                </div>
                            </article>
                        </div>
                        </c:forEach>
