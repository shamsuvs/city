  ...
  <section class="container pt-5 mt-5">
    ...
    <nav aria-label="breadcrumb">
      <ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/all-wayanad-news">News</a></li>
      ...
      <aside class="col-lg-3 offset-xl-1">
        <div class="offcanvas-lg offcanvas-end" id="sidebar">
          ...
          <div class="offcanvas-body">
            ...
            <div class="ignore-dark-mode position-relative w-100 text-center py-4 bg-light border rounded-5 mb-4" style="max-width: 20rem; margin: auto;">
              <h3 class="h2 mb-3">Advertise Here!</h3>
              <p class="mb-3">Want to showcase your brand? <br> Contact us to learn more!</p>
              <a href="/contact-us" class="btn btn-primary px-4 py-2 text-uppercase">
                Contact Us
              </a>
            </div>
