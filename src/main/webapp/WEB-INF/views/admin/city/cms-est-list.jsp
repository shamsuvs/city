    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <h2> All  </h2>
                <p><a href="${pageContext.request.contextPath}/admin/establishment/create" class="btn btn-danger">Add New</a></p>
                <hr>
            ...
            <tbody>
            <c:forEach var="est" items="${estList}" varStatus="i">
                <tr>
                    <td>
                        <input type="checkbox" name="entityId" value="${est.id}">
                    </td>

                    <td colspan="2">
                            <a href="${pageContext.request.contextPath}/admin/establishment/view/${est.id}">${est.estName}</a>
                        </td>
                    <td>
                       ${est.teaser}
                    </td><td>
                  ...
                  <td>
                        <a href="${pageContext.request.contextPath}/admin/establishment/edit/${est.id}" class="btn btn-info">edit</a></td><td>
                        <a href="#" postId="${est.id}" class="deleteChapter btn btn-danger">delete</a>
                    </td>
                </tr>
            </c:forEach>
